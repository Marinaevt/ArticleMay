...
%         fname = sprintf('plot%02dp%01d',k, m);
        fname = sprintf('plot_%02d_%01d',k*5+15, 3+(m-1)*2);% multidome
        in = fopen(fname);
        formatSpec = '%f %f';
        ...
        if m == 1
            ...
            [th, fh] = dist_p2c_v(H, ex(1+(k-1)*9:3+(k-1)*9, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(1+(k-1)*9:3+(k-1)*9, [5 3]));
            Dh(k, m) = sum(fh)/3;
            Ds(k, m) = sum(fs)/3;      
        ...
        elseif m == 2
            ...
            [th, fh] = dist_p2c_v(H, ex(4+(k-1)*9:6+(k-1)*9, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(4+(k-1)*9:6+(k-1)*9, [5 3]));
            Dh(k, m) = sum(fh)/3;
            Ds(k, m) = sum(fs)/3;      
        ...
        elseif m == 3
            ...
            [th, fh] = dist_p2c_v(H, ex(7+(k-1)*9:9+(k-1)*9, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(7+(k-1)*9:9+(k-1)*9, [5 3]));
            Dh(k, m) = sum(fh)/3;
            Ds(k, m) = sum(fs)/3; 
