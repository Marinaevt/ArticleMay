...
%         fname = sprintf('plot%02dp%01d',k, m);
        ...
        if m == 1
            ...
            [th, fh] = dist_p2c_v(H, ex(1:3, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(1:3, [5 4]));
            Dh(k, m) = sum(fh)/10;
            Ds(k, m) = sum(fs)/10;      
        ...
        elseif m == 2
            ...
            [th, fh] = dist_p2c_v(H, ex(4:6, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(4:6, [5 4]));
            Dh(k, m) = sum(fh)/10;
            Ds(k, m) = sum(fs)/10;      
        ...
        elseif m == 3
            ...
            [th, fh] = dist_p2c_v(H, ex(7:9, [5 4]));
            [th, fs] = dist_p2c_v(S, ex(7:9, [5 4]));
            Dh(k, m) = sum(fh)/10;
            Ds(k, m) = sum(fs)/10; 
